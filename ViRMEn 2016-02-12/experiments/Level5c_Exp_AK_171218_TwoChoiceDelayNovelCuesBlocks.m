function code = Level5b_Exp_AK_170510_TwoChoiceDelayNovelCues
...
switch vr.STATE
    case 'INIT_TRIAL'
        ...
        if vr.blockTrialNum < vr.blockLength * (1 - vr.percNovelCues)
